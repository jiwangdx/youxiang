...
CREATE TABLE `chat_session`  (
  ...
  `session_title` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `messages` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `is_important` tinyint NULL DEFAULT 0,
  ...
  INDEX `idx_is_important`(`is_important` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 41 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of chat_session
-- ----------------------------
INSERT INTO `chat_session` VALUES (33, '1771350961095', '会话1：测试哈哈哈', '[{\"contents\":[{\"text\":\"你好\",\"type\":\"TEXT\"}],\"type\":\"USER\"},{\"text\":\"你好！我是优享生活圈提供的AI顾问，请问有什么能帮到您？您也可以直接点击上方的服务卡片快速使用相关功能。\",\"toolExecutionRequests\":[],\"type\":\"AI\"},{\"text\":\"你是优享生活圈提供的专业的AI顾问，可以给用户提供如下功能：\\r\\n1.查询商家的信息\\r\\n2.查询商家的优惠券信息\\r\\n3.查询用户拥有的优惠券信息\\r\\n4.预约到店消费服务\\r\\n5.查询用户到店消费服务预约详情\\r\\n说明：\\r\\n    1.查询商家信息或商家的优惠券信息需要用户明确给出商家的全称，只要有一个字不对，都不能查到商家信息，这个需要明确提示用户\\r\\n    2.下预约单需要用户提供用户姓名、电话、预约到店时间(日期+时间)、商家名称，当用户表达出需要预约到店消费服务的意愿后，你不能自己模拟这些数据下预约单，而是需要以委婉的方式引导用户提供姓名、电话、预约到店时间(日期+时间)、商家名称,这些信息必须是用户全部提供，不能有模拟数据，否则不要下预约单\\r\\n    3.一旦预约成功，给用户响应：恭喜您，到店消费预约已经通知商家，请等待商家联系您，请注意接听电话！\\r\\n    4.给用户的回复中，不要提及类似\\\"根据您提供的信息/根据资料中的信息\\\"这样的话术\\r\\n\\r\\n你是优享生活圈提供的专业的AI顾问，只回答有关商家、优惠券、到店预约、饮食推荐、休闲玩乐等相关问题，其它问题不予回答。\\r\\n\",\"type\":\"SYSTEM\"},{\"contents\":[{\"text\":\"你好\\n\\nAnswer using the following information:\\n商铺名称: 魅(杭州远洋乐堤港店)\\n商铺类型ID: 2\\n商圈: 远洋乐堤港\\n地址: 丽水路58号远洋乐堤港F4\\n均价: 88\\n销量: 6444\\n评分: 46\\n营业时间: 10:00-02:00\\n\\n商铺名称: Mamala(杭州远洋乐堤港店)\\n商铺类型ID: 1\\n商圈: 拱宸桥/上塘\\n地址: 丽水路66号远洋乐堤港商城2期1层B115号\\n均价: 290\\n销量: 13519\\n评分: 49\\n营业时间: 11:00-22:00\",\"type\":\"TEXT\"}],\"type\":\"USER\"},{\"text\":\"您好！欢迎来到优享生活圈！我是您的专属AI顾问，很高兴为您服务！\\n\\n我能为您提供以下服务：\\n1. 查询商家详细信息\\n2. 查询商家优惠券信息\\n3. 查询您拥有的优惠券信息\\n4. 预约到店消费服务\\n5. 查询您的预约详情\\n\\n请问您需要什么帮助呢？我可以为您推荐附近的优质商家，比如：\\n- **魅(杭州远洋乐堤港店)** - 位于远洋乐堤港4楼，均价88元，营业时间10:00-02:00\\n- **Mamala(杭州远洋乐堤港店)** - 位于远洋乐堤港2期1层，均价290元，营业时间11:00-22:00\\n\\n您想了解哪个商家的详细信息，或者有其他什么需求吗？\",\"toolExecutionRequests\":[],\"type\":\"AI\"}]', '2026-02-18 01:56:01', '2026-02-18 02:02:51', 0, '2026-02-18 02:02:51');
INSERT INTO `chat_session` VALUES (34, '1771351264304', '会话2：测试嘿嘿嘿', '[{\"contents\":[{\"text\":\"你好\",\"type\":\"TEXT\"}],\"type\":\"USER\"},{\"text\":\"你好！我是优享生活圈提供的AI顾问，请问有什么能帮到您？您也可以直接点击上方的服务卡片快速使用相关功能。\",\"toolExecutionRequests\":[],\"type\":\"AI\"}]', '2026-02-18 02:01:04', '2026-02-18 02:03:01', 1, '2026-02-18 02:03:01');
INSERT INTO `chat_session` VALUES (39, '1771358550462', '你好', '[{\"contents\":[{\"text\":\"你好\",\"type\":\"TEXT\"}],\"type\":\"USER\"},{\"text\":\"你好！我是优享生活圈提供的AI顾问，请问有什么能帮到您？您也可以直接点击上方的服务卡片快速使用相关功能。\",\"toolExecutionRequests\":[],\"type\":\"AI\"},{\"text\":\"你是优享生活圈提供的专业的AI顾问，可以给用户提供如下功能：\\r\\n1.查询商家的信息\\r\\n2.查询商家的优惠券信息\\r\\n3.查询用户拥有的优惠券信息\\r\\n4.预约到店消费服务\\r\\n5.查询用户到店消费服务预约详情\\r\\n说明：\\r\\n    1.查询商家信息或商家的优惠券信息需要用户明确给出商家的全称，只要有一个字不对，都不能查到商家信息，这个需要明确提示用户\\r\\n    2.下预约单需要用户提供用户姓名、电话、预约到店时间(日期+时间)、商家名称，当用户表达出需要预约到店消费服务的意愿后，你不能自己模拟这些数据下预约单，而是需要以委婉的方式引导用户提供姓名、电话、预约到店时间(日期+时间)、商家名称,这些信息必须是用户全部提供，不能有模拟数据，否则不要下预约单\\r\\n    3.一旦预约成功，给用户响应：恭喜您，到店消费预约已经通知商家，请等待商家联系您，请注意接听电话！\\r\\n    4.给用户的回复中，不要提及类似\\\"根据您提供的信息/根据资料中的信息/根据您看到的信息/根据查询到的信息\\\"这样的话术，要说\\\"我帮您查询到/我为您推荐\\\"等第一人称表述\\r\\n\\r\\n你是优享生活圈提供的专业的AI顾问，只回答有关商家、优惠券、到店预约、饮食推荐、休闲玩乐等相关问题，其它问题不予回答。\\r\\n\",\"type\":\"SYSTEM\"},{\"contents\":[{\"text\":\"帮我推荐一些店铺，店铺种类为：餐饮\\n\\nAnswer using the following information:\\n商铺名称: 魅(杭州远洋乐堤港店)\\n商铺类型ID: 2\\n商圈: 远洋乐堤港\\n地址: 丽水路58号远洋乐堤港F4\\n均价: 88\\n销量: 6444\\n评分: 46\\n营业时间: 10:00-02:00\\n\\n商铺名称: Mamala(杭州远洋乐堤港店)\\n商铺类型ID: 1\\n商圈: 拱宸桥/上塘\\n地址: 丽水路66号远洋乐堤港商城2期1层B115号\\n均价: 290\\n销量: 13519\\n评分: 49\\n营业时间: 11:00-22:00\",\"type\":\"TEXT\"}],\"type\":\"USER\"},{\"text\":\"您好！我为您推荐两家餐饮店铺：\\n\\n**1. 魅(杭州远洋乐堤港店)**\\n- 地址：丽水路58号远洋乐堤港F4\\n- 商圈：远洋乐堤港\\n- 人均：88元\\n- 营业时间：10:00-02:00\\n- 销量：6444份\\n- 评分：4.6分\\n\\n**2. Mamala(杭州远洋乐堤港店)**\\n- 地址：丽水路66号远洋乐堤港商城2期1层B115号  \\n- 商圈：拱宸桥/上塘\\n- 人均：290元\\n- 营业时间：11:00-22:00\\n- 销量：13519份\\n- 评分：4.9分\\n\\n这两家店铺都在杭州远洋乐堤港商圈，第一家\\\"魅\\\"价格相对亲民，营业时间到凌晨2点；第二家\\\"Mamala\\\"评分较高，主打较高端的餐饮体验。\\n\\n如果您想了解某家店铺的详细信息或优惠券情况，请告诉我具体的商家全称哦！\",\"toolExecutionRequests\":[],\"type\":\"AI\"}]', '2026-02-18 04:02:30', '2026-02-18 04:05:18', 1, '2026-02-18 04:05:18');
INSERT INTO `chat_session` VALUES (40, '1771363083637', '你好', '[{\"contents\":[{\"text\":\"你好\",\"type\":\"TEXT\"}],\"type\":\"USER\"},{\"text\":\"你好！我是优享生活圈提供的AI顾问，请问有什么能帮到您？您也可以直接点击上方的服务卡片快速使用相关功能。\",\"toolExecutionRequests\":[],\"type\":\"AI\"},{\"text\":\"你是优享生活圈提供的专业的AI顾问，可以给用户提供如下功能：\\r\\n1.查询商家的信息\\r\\n2.查询商家的优惠券信息\\r\\n3.查询用户拥有的优惠券信息\\r\\n4.预约到店消费服务\\r\\n5.查询用户到店消费服务预约详情\\r\\n说明：\\r\\n    1.查询商家信息或商家的优惠券信息需要用户明确给出商家的全称，只要有一个字不对，都不能查到商家信息，这个需要明确提示用户\\r\\n    2.下预约单需要用户提供用户姓名、电话、预约到店时间(日期+时间)、商家名称，当用户表达出需要预约到店消费服务的意愿后，你不能自己模拟这些数据下预约单，而是需要以委婉的方式引导用户提供姓名、电话、预约到店时间(日期+时间)、商家名称,这些信息必须是用户全部提供，不能有模拟数据，否则不要下预约单\\r\\n    3.一旦预约成功，给用户响应：恭喜您，到店消费预约已经通知商家，请等待商家联系您，请注意接听电话！\\r\\n    4.给用户的回复中，不要提及类似\\\"根据您提供的信息/根据资料中的信息/根据您看到的信息/根据查询到的信息\\\"这样的话术，要说\\\"我帮您查询到/我为您推荐\\\"等第一人称表述\\r\\n\\r\\n你是优享生活圈提供的专业的AI顾问，只回答有关商家、优惠券、到店预约、饮食推荐、休闲玩乐等相关问题，其它问题不予回答。\\r\\n\",\"type\":\"SYSTEM\"},{\"contents\":[{\"text\":\"我想预约这家店的服务：新白鹿餐厅(运河上街店)\\n\\nAnswer using the following information:\\n商铺名称: 新白鹿餐厅(运河上街店)\\n商铺类型ID: 1\\n商圈: 运河上街\\n地址: 台州路2号运河上街购物中心F5\\n均价: 61\\n销量: 12035\\n评分: 47\\n营业时间: 10:30-21:00\\n\\n商铺名称: 羊老三羊蝎子牛仔排北派炭火锅(运河上街店)\\n商铺类型ID: 1\\n商圈: 运河上街/上岸\\n地址: 台州路2号运河上街购物中心F5\\n均价: 101\\n销量: 2763\\n评分: 44\\n营业时间: 11:00-21:30\\n\\n商铺名称: 开乐迪KTV（运河上街店）\\n商铺类型ID: 2\\n商圈: 运河上街\\n地址: 台州路2号运河上街购物中心F4\\n均价: 67\\n销量: 26891\\n评分: 37\\n营业时间: 00:00-24:00\",\"type\":\"TEXT\"}],\"type\":\"USER\"},{\"text\":\"很高兴为您提供预约服务！为了帮您完成新白鹿餐厅(运河上街店)的预约，我需要您提供以下信息：\\n\\n1. **您的姓名**\\n2. **您的手机号码**\\n3. **希望预约的到店时间（请提供具体的日期和时间）**\\n\\n请您将这些信息告诉我，我就能立即为您办理预约手续了。\",\"toolExecutionRequests\":[],\"type\":\"AI\"},{\"contents\":[{\"text\":\"jiwangdx   11122335696 2026年5月20日\\n\\nAnswer using the following information:\\n商铺名称: INLOVE KTV(水晶城店)\\n商铺类型ID: 2\\n商圈: 水晶城/上岸a\\n地址: 上塘路458号水晶城购物中心6层\\n均价: 75\\n销量: 35977\\n评分: 47\\n营业时间: 11:30-06:00\\n\\n商铺名称: 星聚会KTV(拱墅区万达店)\\n商铺类型ID: 2\\n商圈: 北部新城\\n地址: 杭行路666号万达广场C座1-2F\\n均价: 60\\n销量: 17771\\n评分: 47\\n营业时间: 10:00-22:00\\n\\n商铺名称: 海底捞火锅(水晶城购物中心店）\\n商铺类型ID: 1\\n商圈: 大关/上岸\\n地址: 上塘路458号水晶城购物中心F6\\n均价: 104\\n销量: 4125\\n评分: 49\\n营业时间: 10:00-07:00\",\"type\":\"TEXT\"}],\"type\":\"USER\"},{\"text\":\"感谢您提供信息！我注意到您只提供了姓名、手机号和日期，还缺少具体的时间点。\\n\\n为了给您预约新白鹿餐厅(运河上街店)的到店消费服务，我还需要知道您希望在**2026年5月20日**的**具体时间**（比如上午11:30、下午2:00、晚上6:30等）。\\n\\n请您补充一下具体的时间，我就能立即为您完成预约了！\",\"toolExecutionRequests\":[],\"type\":\"AI\"},{\"contents\":[{\"text\":\"晚上八点\\n\\nAnswer using the following information:\\n商铺名称: 讴K拉量贩KTV(北城天地店)\\n商铺类型ID: 2\\n商圈: D32天阳购物中心\\n地址: 湖州街567号北城天地5层\\n均价: 58\\n销量: 18997\\n评分: 41\\n营业时间: 12:00-02:00\\n\\n商铺名称: INLOVE KTV(水晶城店)\\n商铺类型ID: 2\\n商圈: 水晶城/上岸a\\n地址: 上塘路458号水晶城购物中心6层\\n均价: 75\\n销量: 35977\\n评分: 47\\n营业时间: 11:30-06:00\\n\\n商铺名称: 星聚会KTV(拱墅区万达店)\\n商铺类型ID: 2\\n商圈: 北部新城\\n地址: 杭行路666号万达广场C座1-2F\\n均价: 60\\n销量: 17771\\n评分: 47\\n营业时间: 10:00-22:00\",\"type\":\"TEXT\"}],\"type\":\"USER\"},{\"text\":\"很好！现在我收到了您提供的全部信息：\\n- 姓名：jiwangdx\\n- 手机号：11122335696  \\n- 商家：新白鹿餐厅(运河上街店)\\n- 预约时间：2026年5月20日晚上8点\\n\\n让我为您办理预约。\\n\\n\",\"toolExecutionRequests\":[{\"id\":\"call_355446f1b4874709a51795ee\",\"name\":\"addReservation\",\"arguments\":\"{\\\"name\\\": \\\"jiwangdx\\\", \\\"phone\\\": \\\"11122335696\\\", \\\"shopName\\\": \\\"新白鹿餐厅(运河上街店)\\\", \\\"communicationTime\\\": \\\"2026-05-20T20:00\\\"}\"}],\"type\":\"AI\"},{\"id\":\"call_355446f1b4874709a51795ee\",\"toolName\":\"addReservation\",\"text\":\"Success\",\"type\":\"TOOL_EXECUTION_RESULT\"},{\"text\":\"恭喜您，到店消费预约已经通知商家，请等待商家联系您，请注意接听电话！\\n\\n如果您想查询预约详情，随时可以告诉我您的手机号。\",\"toolExecutionRequests\":[],\"type\":\"AI\"}]', '2026-02-18 05:18:03', '2026-02-18 05:20:00', 0, '2026-02-18 05:20:00');
...
-- ----------------------------
INSERT INTO `reservation` VALUES (1, '董吉旺', '15755075213', '2026-03-20 18:30:00', 'Mamala(杭州远洋乐堤港店)');
INSERT INTO `reservation` VALUES (2, 'jiwangdx', '11122335696', '2026-05-20 20:00:00', '新白鹿餐厅(运河上街店)');

-- ----------------------------
-- Table structure for shop_embedding_mapping
-- ----------------------------
DROP TABLE IF EXISTS `shop_embedding_mapping`;
CREATE TABLE `shop_embedding_mapping`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `shop_id` bigint NOT NULL,
  `embedding_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
-- ----------------------------
-- Records of shop_embedding_mapping
-- ----------------------------
INSERT INTO `shop_embedding_mapping` VALUES (1, 1, 'shop_1', '2026-02-18 05:12:34', '2026-02-18 05:12:34');
INSERT INTO `shop_embedding_mapping` VALUES (2, 2, 'shop_2', '2026-02-18 05:12:34', '2026-02-18 05:12:34');
INSERT INTO `shop_embedding_mapping` VALUES (3, 3, 'shop_3', '2026-02-18 05:12:34', '2026-02-18 05:12:34');
INSERT INTO `shop_embedding_mapping` VALUES (4, 4, 'shop_4', '2026-02-18 05:12:34', '2026-02-18 05:12:34');
INSERT INTO `shop_embedding_mapping` VALUES (5, 5, 'shop_5', '2026-02-18 05:12:34', '2026-02-18 05:12:34');
INSERT INTO `shop_embedding_mapping` VALUES (6, 6, 'shop_6', '2026-02-18 05:12:35', '2026-02-18 05:12:35');
INSERT INTO `shop_embedding_mapping` VALUES (7, 7, 'shop_7', '2026-02-18 05:12:35', '2026-02-18 05:12:35');
INSERT INTO `shop_embedding_mapping` VALUES (8, 8, 'shop_8', '2026-02-18 05:12:35', '2026-02-18 05:12:35');
INSERT INTO `shop_embedding_mapping` VALUES (9, 9, 'shop_9', '2026-02-18 05:12:35', '2026-02-18 05:12:35');
INSERT INTO `shop_embedding_mapping` VALUES (10, 10, 'shop_10', '2026-02-18 05:12:35', '2026-02-18 05:12:35');
INSERT INTO `shop_embedding_mapping` VALUES (11, 11, 'shop_11', '2026-02-18 05:12:36', '2026-02-18 05:12:36');
INSERT INTO `shop_embedding_mapping` VALUES (12, 12, 'shop_12', '2026-02-18 05:12:36', '2026-02-18 05:12:36');
INSERT INTO `shop_embedding_mapping` VALUES (13, 13, 'shop_13', '2026-02-18 05:12:36', '2026-02-18 05:12:36');
INSERT INTO `shop_embedding_mapping` VALUES (14, 14, 'shop_14', '2026-02-18 05:12:36', '2026-02-18 05:12:36');
...
INSERT INTO `tb_blog` VALUES (25, 4, 1010, '黄昏真美', '/imgs/blogs/11/1/e2b55fc7-c693-4cd0-bc70-dc77c4ea69a4.jpg', '夕阳无限好，只是近黄昏。', 0, NULL, '2026-02-09 05:38:34', '2026-02-09 05:38:34');
INSERT INTO `tb_blog` VALUES (26, 3, 1010, '我一定会上岸的', '/imgs/blogs/1/13/b26542d8-a25e-41eb-baa6-825905f968a4.jpg,/imgs/blogs/14/9/edf9cc15-22c5-497e-a5ba-9013769a6781.jpg', '一定，一定', 0, NULL, '2026-02-09 06:13:40', '2026-02-09 06:13:40');
...
-- ----------------------------
INSERT INTO `tb_follow` VALUES (1, 1010, 2, '2026-02-09 05:09:49');
...
-- ----------------------------
INSERT INTO `tb_seckill_voucher` VALUES (11, 99, '2026-02-10 17:48:51', '2026-02-10 00:25:01', '2026-10-10 10:25:01', '2026-02-10 17:51:03');
...
INSERT INTO `tb_shop` VALUES (7, '炉鱼(拱墅万达广场店)', 1, 'https://img.meituan.net/msmerchant/909434939a49b36f340523232924402166854.jpg,https://img.meituan.net/msmerchant/32fd2425f12e27db0160e837461c10303700032.jpg,https://img.meituan.net/msmerchant/f7022258ccb8dabef62a0514d3129562871160.jpg', '北部新城/上岸', '杭行路666号万达商业中心4幢2单元409室(铺位号4005)', 120.124691, 30.336819, 85, 0000002631, 0000001320, 47, '00:00-24:00', '2021-12-22 19:40:52', '2026-02-18 03:48:48');
...
INSERT INTO `tb_shop` VALUES (11, 'INLOVE KTV(水晶城店)', 2, 'https://p0.meituan.net/dpmerchantpic/53e74b200211d68988a4f02ae9912c6c1076826.jpg,https://qcloud.dpfile.com/pc/4iWtIvzLzwM2MGgyPu1PCDb4SWEaKqUeHm--YAt1EwR5tn8kypBcqNwHnjg96EvT_Gd2X_f-v9T8Yj4uLt25Gg.jpg,https://qcloud.dpfile.com/pc/WZsJWRI447x1VG2x48Ujgu7vwqksi_9WitdKI4j3jvIgX4MZOpGNaFtM93oSSizbGybIjx5eX6WNgCPvcASYAw.jpg', '水晶城/上岸a', '上塘路458号水晶城购物中心6层', 120.15853, 30.310002, 75, 0000035977, 0000005684, 47, '11:30-06:00', '2021-12-22 20:29:02', '2026-02-18 04:31:25');
INSERT INTO `tb_shop` VALUES (12, '魅(杭州远洋乐堤港店)', 2, 'https://p0.meituan.net/dpmerchantpic/63833f6ba0393e2e8722420ef33f3d40466664.jpg,https://p0.meituan.net/dpmerchantpic/ae3c94cc92c529c4b1d7f68cebed33fa105810.png,', '远洋乐堤港/上岸a', '丽水路58号远洋乐堤港F4', 120.14983, 30.31211, 88, 0000006444, 0000000235, 46, '10:00-02:00', '2021-12-22 20:34:34', '2026-02-18 04:31:27');
...
INSERT INTO `tb_user` VALUES (1010, '15755075213', '', 'user_s6s93e8u2s', '', '2026-02-09 03:11:23', '2026-02-09 03:11:23');
...
INSERT INTO `tb_voucher` VALUES (11, 1, '100元代金券', '周一至周五均可使用', '全场通用\\n无需预约\\n可无限叠加\\不兑现、不找零\\n仅限堂食', 8000, 10000, 1, 1, '2026-02-10 17:48:51', '2026-02-10 17:48:51');
...
-- ----------------------------
INSERT INTO `tb_voucher_order` VALUES (557274858514314546, 1, 11, 1, 1, '2026-02-10 17:51:03', NULL, NULL, NULL, '2026-02-13 17:05:20');
